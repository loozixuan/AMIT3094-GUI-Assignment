        ...
        <div id="main">           
            ...
            <div id="checkout-container">
                <div id="checkout">
                    ...
                    <div>
                        <a href="/HobbitHall/Client/Payment/Payment.jsp" class="btn btn-dark" style="width: 100%;">CONTINUE TO CHECK OUT</a>
                    </div>
                </div>
            </div>
            <% } else { %>
            <div class="mt-5">
                ...
                <div class="row justify-content-center px-5">
                    <a href="/HobbitHall/ShoppingCart?action=add&product_ID=PE9&qtyBuy=1" class="col-md-3 bg-danger text-white text-center border border-5 py-3 mt-3">Shop our products</a>
                </div>
            </div>
            <% }
            } else { %>
